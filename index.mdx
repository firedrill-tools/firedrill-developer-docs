...
<Note>
  The local framework is a release candidate published under the `@firedrill-run` npm scope. The [quickstart](/quickstart) installs it directly from npm.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Use Firedrill in code" icon="code" href="/sdk/overview">
    Drive local worlds and drills through the TypeScript or Python SDK.
  </Card>
</CardGroup>
...
<Card title="Run the quickstart" icon="arrow-right" href="/quickstart">
  Go from installation to a passing drill and a local HTML report.
</Card>
