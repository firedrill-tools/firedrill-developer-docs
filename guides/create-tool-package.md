...
`@firedrill/compiler/schema/installed-tool-package`; the declaration contract is
`@firedrill/compiler/schema/tool-source`. The installed schemas work without a
