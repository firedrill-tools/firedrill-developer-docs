...
Do not infer a field when validation rejects it. Inspect the emitted schemas from `@firedrill/compiler/schema/*` and `@firedrill/contracts/schema/*` when examples are insufficient.
