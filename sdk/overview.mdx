...
| --- | --- | --- | --- |
| `@firedrill-tools/sdk` | TypeScript | Create local worlds, run drills, inject test setup, and write local reports | Public release candidate on npm (`next`) |
| `@firedrill-tools/cloud` | TypeScript | Control hosted projects, sessions, runs, evidence, and browser tests | Public package for authorized Cloud preview users |
